...
MapHS02:
	...
	db PEWTER_CITY,$08,Show
	db PEWTER_CITY,$09,Show
	db PEWTER_CITY,$0A,Show
MapHS03:
...
MapHS28:
	...
	db OAKS_LAB,$08,Hide
MapHS2B:
	db VIRIDIAN_SCHOOL_HOUSE,$08,Hide
	db VIRIDIAN_SCHOOL_HOUSE,$0A,Show
MapHS2D:
