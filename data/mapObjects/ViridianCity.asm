ViridianCity_Object:
	...
	warp 21, 15, 0, PEWTER_SPEECH_HOUSE
	warp 21, 9, 0, BLUES_HOUSE
	warp 32, 7, 0, VIRIDIAN_GYM

	db 6 ; signs
	sign 17, 17, 15 ; ViridianCityText15
	...
	object SPRITE_GAMBLER, 13, 18, STAY, NONE, 2 ; person
	...
	object SPRITE_BALL, 27, 16, STAY, NONE, 8 ; person

	; warp-to
	warp_to 23, 25, VIRIDIAN_CITY_WIDTH ; VIRIDIAN_POKECENTER
	warp_to 29, 19, VIRIDIAN_CITY_WIDTH ; VIRIDIAN_MART
	warp_to 21, 15, VIRIDIAN_CITY_WIDTH ; PEWTER_SPEECH_HOUSE
	warp_to 21, 9, VIRIDIAN_CITY_WIDTH ; BLUES_HOUSE
