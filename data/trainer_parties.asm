...
Green1Data:
	db $FF,2,STARTER2,3,ELECTABUZZ,4,WARTORTLE_3,0
...
; Route 22
	db $FF,2,GRAVELER,3,ELECTABUZZ,4,WARTORTLE_3,0
...
LanceData:
	db $FF,1,GOLEM,1,MAGMAR,1,ELECTABUZZ,1,HYPNO,1,PINSIR,1,WARTORTLE_3,0