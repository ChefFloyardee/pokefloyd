...
Green1Data:
	...
	db $FF,20,STARTER3,2,ELECTABUZZ,22,WARTORTLE_3,0
	db $FF,20,STARTER1,2,ELECTABUZZ,22,WARTORTLE_3,0
; Route 22
...
BrockData:
	db $FF,1,KANGASKHAN,1,PORYGON,1,DITTO,0
MistyData:
...
LanceData:
	db $FF,58,GOLEM,58,GYARADOS,56,DRAGONAIR,56,DRAGONAIR,60,AERODACTYL,62,DRAGONITE,0