...
Green1Data:
	db $FF,20,STARTER2,25,ELECTABUZZ,26,WARTORTLE_3,0
	db $FF,20,STARTER3,25,ELECTABUZZ,26,WARTORTLE_3,0
	db $FF,20,STARTER1,25,ELECTABUZZ,26,WARTORTLE_3,0
; Route 22
	db $FF,1,PIDGEY,1,SQUIRTLE,0
...
ProfOakData:
; Unused
	db $FF,40,SNORLAX,42,MOLTRES,44,IVYSAUR,46,PRIMEAPE,48,ALAKAZAM,50,WARTORTLE_2,0
	db $FF,40,SNORLAX,42,MOLTRES,44,IVYSAUR,46,PRIMEAPE,48,ALAKAZAM,50,WARTORTLE_2,0
	db $FF,40,SNORLAX,42,MOLTRES,44,IVYSAUR,46,PRIMEAPE,48,ALAKAZAM,50,WARTORTLE_2,0
ChiefData:
; none
...
BrockData:
	db $FF,23,KANGASKHAN,24,PORYGON,25,DITTO,0
MistyData:
...
; Route 22
	db $FF,25,GRAVELER,26,ELECTABUZZ,27,WARTORTLE_3,0
	db $FF,25,MACHOKE,26,ELECTABUZZ,27,WARTORTLE_3,0
	db $FF,25,HAUNTER,26,ELECTABUZZ,27,WARTORTLE_3,0
Green3Data:
	db $FF,61,PIDGEOT,59,ALAKAZAM,61,RHYDON,61,GYARADOS,63,ARCANINE,65,BLASTOISE,0
...
LanceData:
	db $FF,30,MACHAMP,32,MAGMAR,34,KABUTOPS,36,HYPNO,38,PINSIR,40,WARTORTLE_3,0
	db $FF,30,GENGAR,32,MAGMAR,34,KABUTOPS,36,HYPNO,38,PINSIR,40,WARTORTLE_3,0
	db $FF,30,GOLEM,32,MAGMAR,34,KABUTOPS,36,HYPNO,38,PINSIR,40,WARTORTLE_3,0
	db $FF,30,ALAKAZAM,32,MAGMAR,34,KABUTOPS,36,HYPNO,38,PINSIR,40,WARTORTLE_3,0